        ...
        <div class="row">
            <div class="col-lg-9">
                        ...
                        $args = array(           
                                ...
                                'tax_query' => array(
							        array(
							            'taxonomy' => 'sidebanner',
							            'field' => 'term_id',
							            'terms' => array($side_term_id)
							        ),
							    ),
                                'paged'=> $paged

                            );
                        $query_sideban = new WP_Query($args);

                    if ($query_sideban->have_posts()) : while ($query_sideban->have_posts()) : $query_sideban->the_post();
                ?>
                    <div class="col-lg-6">
                        <div class="wrap">
             ...
             <?php 
                    ...
                    $total_pages =  $query_sideban->max_num_pages;
